...
function Career() {
  ...
  At Itel Mobile, we believe in the power of collaboration. Working together not only makes us stronger but also propels your business towards unparalleled success. If you're ready to experience the difference that strategic can make, we invite you to reach out to us.
          ...
          <svg focusable="false" className="hero__honeycom lg:h-[370px] h-[120px] lg:w-[320px]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 308.72 465.51">
            ...
            <path d="M245.36,34.33,185.9,0,126.44,34.33V103l59.46,34.33L245.36,103Z" fill="#fff"></path>
            <path d="M182.1,143.68l-59.46-34.33L63.18,143.68v68.66l59.46,34.33,59.46-34.33Z" fill="#fff"></path>
            <path d="M308.61,143.68l-59.46-34.33-59.46,34.33v68.66l59.46,34.33,59.46-34.33Z" fill="#fff"></path>
            <path d="M118.92,253.2,59.46,218.87,0,253.2v68.66l59.46,34.33,59.46-34.33Z" fill="#fff"></path>
            <path d="M245.46,253.2,186,218.87,126.54,253.2v68.66L186,356.19l59.46-34.33Z" fill="#fff"></path>
            <path d="M308.72,362.52l-59.46-34.33L189.8,362.52v68.66l59.46,34.33,59.46-34.33Z" fill="#fff"></path>
          </svg>
        </div>
      </div>
      ...
      <div className="bg-gray-100 mb-10 mt-10 p-8 rounded-lg shadow-md">
        ...
        <ul className="mt-4">
          <li className="flex items-center">
            ...
            Design and develop innovative mobile applications for various platforms.
          </li>
        ...
        <p className="text-gray-700 mt-4">
          To apply, send your resume and a cover letter to <a href="mailto:email@example.com" className="text-blue-500">Tiwhite854@gmail.com</a>.
        </p>
      </div>
    </div>
  )

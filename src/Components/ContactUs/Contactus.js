  ...
  return (
    <div>
        ...
        <div className="flex flex-col-reverse lg:flex-row justify-between lg:gap-2">
          <div className=" justify-center  lg:ps-10 flex flex-col gap-6">
            <h1 className="text-[#D1D5DB] text-center font-semibold font-[raleway] mt-5 lg:mt-0 text-2xl lg:text-5xl">
              Get in Touch with Itel Mobile
            </h1>
            <p className="text-white mb-10 lg:mb-0 text-center lg: lg:text-start font-[poppins] text-sm lg:w-[750px] lg:ps-10 ">
              At itel Mobile Store, we embrace the power of teamwork. By collaborating, we strengthen our capabilities and propel your mobile shopping experience towards unparalleled satisfaction. If you're ready to discover the difference that innovative mobile solutions can bring, we welcome you to connect with us.
            </p>
          </div>
      ...
      <div
        ...
        <div className="bg-[#222222] lg:w-[400px] border-b-4 border-[#ff063c]">
          <div className="text-white ps-6 p-4 pt-4 flex flex-col gap-8 justify-center ">
            ...
            <div>
              ...
              <ul className="mt-3">
                <li className="  ">Monday – Sunday 9am to 9pm</li>
              </ul>
            </div>
            <div>
              <span className="text-2xl pt-4 font-[poppins] font-bold ">
            ...
            <div>
              ...
              <ul className="mt-3">
                <li className="  ">4, N Usman Rd, </li>
                <li className="  ">Parthsarathy Puram, Parthasarathi Puram,</li>
                <li className="  "> T. Nagar, Chennai, Tamil Nadu 600017</li>
              </ul>
            </div>
          </div>
        </div>
